...
use Puzzle\OAuthServerBundle\Form\Handler\AuthorizeFormHandler;
...
class AuthorizeController
{
    ...
    public function authorizeAction(Request $request)
    {
        ...
        // Skip acceptation step
        if(true == $this->getClient()->isInterne()){
    ...
    protected function renderAuthorize(array $data, EngineInterface $engine, string $engineType): Response
    {
        return $engine->renderResponse(
            'PuzzleOAuthServerBundle:Authorize:authorize.html.'.$engineType,
            $data
            );
    }
